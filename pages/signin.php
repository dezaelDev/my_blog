...
<body>
	...
	<div class="container">
		...
		<div class="card">
			...
			<h1 class="card__title">Registrate</h1>
			...
			<form class="card__form" method="post">
				...
				<div class="card__form_inputs">
					...
					<div class="normalInput normalInput-lbl-color-focus-v-secondary normalInput-line-color-focus-v-secondary">
						<input class="normalInput__box" type="text" name="name" required>
						<label class="normalInput__lbl" for="name">Nombre Completo</label>
					</div>
				...
				<button class="normalBtn normalBtn-ratio-v-7 btn-bg-initial-v-primary btn-bg-hover-v-light normalBtn-size-v-m normalBtn-text-color-hover-v-dark btn-border-radius-v-xs" type="submit">Crear</button>
